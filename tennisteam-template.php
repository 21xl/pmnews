<?php
/*
Template Name: Tennis Team
Template Post Type: tennis_team
*/
                ...
                <section class="statistics">
                    <div class="statistics__wrapper wrapper">
                        ...
                        <div class="statistics__main">
                            <?php get_template_part('template-parts/sport/tennis/statistics-sidebar', null, ['page_data' => 'team']) ?>

                            <?php get_template_part('template-parts/sport/tennis/statistics-team') ?>
...
<script src="<?php echo get_template_directory_uri() . '/sport/tennis/js/team/index.min.js' ?>"></script>
