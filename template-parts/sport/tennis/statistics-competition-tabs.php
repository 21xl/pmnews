...
$tabs_data = array('scheduled', 'live', 'results', 'standings');
...
$tabs = array(
    ...
    $base_url . 'standings/' => 'Tournament Grid',
);
...
<div class="statistics-category__links links" data-tab="<?= $tabs_data[$active_tab_index] ?>">
