                ...
                <section class="statistics">
                    <div class="statistics__wrapper wrapper">
                        ...
                        <div class="statistics__main">
                            <?php get_template_part('template-parts/sport/tennis/statistics-sidebar', null, ['page_data' => 'category']) ?>

                            <?php get_template_part('template-parts/sport/tennis/statistics-category') ?>
