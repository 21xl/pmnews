...
$custom_meta_description = 'See match results' . $title . '. Don`t miss the most important games of the season! Find out the results of all the games of the season quickly and conveniently in one place!';
                ...
                <section class="statistics">
                    <div class="statistics__wrapper wrapper">
                        ...
                        <div class="statistics__main">
                            ...
                            <?php get_template_part('template-parts/sport/tennis/statistics-competition-results') ?>
...
<script src="<?php echo get_template_directory_uri() . '/sport/tennis/js/competition/index.min.js' ?>"></script>
