					...
					<div id="resluting-search__wrapper">
						...
						if ($search_query) {
							...
							if (!empty($category_results)) {
								echo '<p class="resluting-search__subtitle">' . pll__('Категории') . ' (' . count($category_results) . ')</p>
							...
							if (!empty($tag_results)) {
								echo '<p class="resluting-search__subtitle">' . pll__('Теги') . ' (' . count($tag_results) . ')</p>
							...
							if ($search_results_pages->have_posts()) {
								...
								echo '<p class="resluting-search__subtitle">' . pll__('Страницы') . ' (' . $page_count . ')</p>
							...
							if (!empty($user_results)) {
								echo '<p class="resluting-search__subtitle">' . pll__('Авторы') . ' (' . count($user_results) . ')</p>
								...
								foreach ($user_results as $user) {
									...
									echo '<p class="user-role">' . esc_html($author_position ? $author_position : 'Автор') . '</p>';
									echo '</div>';
									echo '</a>';
									echo '</div>';
								}
							...
							if ($search_results_posts->have_posts()) {
								echo '<p class="resluting-search__subtitle">' . pll__('Новости') . ' (' . $search_results_posts->found_posts . ')</p>';
